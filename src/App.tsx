...
export default function App() {
  const [currentPage, setCurrentPage] = useState<'home' | 'test' | 'search'>('home');
  ...
  // 여기 숫자만 바꾸면 윗덩어리가 통째로 내려감/올라감
  // 아래로 더 내리고 싶으면 px 값을 더 크게
  // 위로 올리고 싶으면 더 작게
          ...
          <div className="w-[85%] mx-auto flex flex-col items-center">
            ...
            <div className={heroOffsetClass}>
              ...
              <div className="flex flex-col items-center text-center max-w-3xl space-y-0">
                ...
                <h1
                  className={`
                    font-['Pretendard']
                    text-[85px] font-bold leading-tight
                    text-[#00d9b1]
                  `}
                >
                  자신있게 노래하세요
            ...
            <div className="w-full mt-32 grid md:grid-cols-3 gap-12">
              ...
              >
                ...
                <p className={`text-[16px] ${textTertiary}`}>테시투라 기반으로 정확한 음역대 분석</p>
              </div>
              ...
              >
                ...
                <p className={`text-[16px] ${textTertiary}`}>당신에게 맞는 키로 추천</p>
              </button>
          ...
          >
            ...
            <div className="px-10 pb-6 space-y-8">
              <div className="flex gap-6 items-start">
                <div className={`flex-shrink-0 w-16 h-16 rounded-2xl ${cardBg} border ${border} flex items-center justify-center`}>
              ...
              <div className="flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className={`font-['Pretendard'] text-[16px] ${textSecondary} leading-relaxed`}>
                    억지로 높은 음이나 낮은 음을 내지 말고, 편안하게 부를 수 있는 음역대로 노래해주세요
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className={`font-['Pretendard'] text-[16px] ${textSecondary} leading-relaxed`}>
                    헤드폰이나 이어폰 착용 시 더 정확한 측정이 가능합니다
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className={`mx-10 mb-6 p-6 rounded-2xl ${cardBg} border ${border}`}>
              <p className={`font-['Pretendard'] text-[16px] ${textSecondary} leading-relaxed text-center`}>
                <span className={`font-semibold ${textColor}`}>💡 테스트 방법:</span> 시스템이 제시음을 재생하면 해당 음을 따라 불러주세요
              </p>
            </div>
